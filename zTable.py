...
>>> from zTable import z_table
>>> z_table[2.59]
0.9952
"""

# z_table is a dictionary whose keys are positive z-scores from 0 to 3.49
# and values are the cumulative area to the left of the score on the standard
